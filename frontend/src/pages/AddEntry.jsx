      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="vertical-form">
          <div className="form-header">
            ...
            <button type="button" className="close-btn" onClick={resetForm} aria-label="Close form">
              ×
            </button>
          </div>
          ...
          <label>
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, hospital_id: e.target.value ? parseInt(e.target.value) : '' })
              }
          ...
          <div className="payment-grid">
            ...
            <label>
              Balance Amount (₹)
              <input type="text" value={balanceAmount.toFixed(2)} readOnly className="balance-readonly" />
            </label>
          </div>
                ...
                <tr key={entry.id}>
                  ...
                  <td>
                    <div className="entry-actions">
                      <button type="button" onClick={() => handleEdit(entry)} className="edit-btn">
                        Edit
                      </button>

                      <button type="button" onClick={() => handleDelete(entry.id)} className="delete-btn">
                        Delete
                      </button>
                    </div>
                  </td>
